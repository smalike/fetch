define("common:chinaso/page/common/controller/nav", ["require", "exports", "module", "common:chinaso/page/common/controller/utils", "common:chinaso/page/controller/event.dispatcher"], function (require, exports, module) {
    "use strict";
    
    var utils = require("common:chinaso/page/common/controller/utils"),
        eventDispatcher = require("common:chinaso/page/controller/event.dispatcher");
    ...
    utils.extend(Nav.prototype, {
        initialize: function () {
            var _this = this,
                $item = _this.defaults.$container.find(_this.defaults.content).eq(0).find(_this.defaults.item).not(_this.defaults.$moreContainer);
        ...
        buildNavMore: function () {
            ...
            $.each($item, function () {
                ...
                if (limitWidth > outW) {
                    _this.$moreView.append($content.find(_this.defaults.item + ":gt(" + ($(this).index() - 3) + ")").not(_this.defaults.$moreContainer));
        ...
        moreEventHandler: function () {
            ...
            _this.$moreView.on({
                mouseover: function (e) {
                    $(e.target || e.srcElement).parent(_this.defaults.item).not(_this.defaults.$moreContainer).addClass(_this.defaults.tagClass).siblings().removeClass(_this.defaults.tagClass);
                },
                mouseout: function (e) {
